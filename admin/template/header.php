        ...
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
          <div class="notification-slider">
            <div class="d-flex h-100"> 
              ...
              <!-- <h4 class="mb-0 f-w-500" style="font-size: 21px;">CA BUSINESS LEADERS AWARD NOMINATION FORM</h4> -->
            <h4 class="mb-0 f-w-500" style="font-size: 21px;">ICAI 40 Under 40 - CA Business Leaders Awards</h4>
