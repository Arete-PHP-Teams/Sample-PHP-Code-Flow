<?php
   ...
   $query = mysqli_query($db, "SELECT * from applicationregistration where  DeletedStatus = '0'  AND FinalStatus='0' ORDER BY ID ASC");
   if(mysqli_num_rows($query) > 0)
   {
    $delimiter = ",";
    $filename = "Partial_Application_Records" . date('Y-m-d') . ".csv";
